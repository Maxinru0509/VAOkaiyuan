function [BestCost,mu_history6] = ODVAO(CostFunction, dim, VarSize, VarMin, VarMax, MaxIt, nPop, omega, psi, lambda, mu, delta)
...
% Merge 合并
        ...
        disp(['In Iteration No ' num2str(it) ': ODVAO Best Cost Is = ' num2str(BestCost(it))]);
    end
%           figure;
%        semilogy(mu_history6,'DisplayName','OD-mu','color','#FF6100','Marker','d','markerindices',(1:30:MaxIt),'MarkerSize',6,'LineStyle','-.','linewidth',1.3);
%        xlabel('Iteration');
