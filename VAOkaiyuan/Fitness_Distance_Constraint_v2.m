function [index1, index2, index3] = Fitness_Distance_Constraint_v2(population, fitness,KI)
...
%                 disp('FDC')
                ...
                divDistances(i) = (normFitness(i) + normDistances_KI(i) + normDistances_pop(i))/3;
            else
%                 disp('FDB')
