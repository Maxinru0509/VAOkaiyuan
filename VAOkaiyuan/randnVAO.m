%% randnVAO Algorithm Function

function [BestCost,mu_history3] = randnVAO(CostFunction, dim, VarSize, VarMin, VarMax, MaxIt, nPop, omega, psi, lambda, mu, mu_damp, delta)
...
% Merge 合并
        ...
        disp(['In Iteration No ' num2str(it) ': randnVAO Best Cost Is = ' num2str(BestCost(it))]);
    end
