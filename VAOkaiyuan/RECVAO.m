function BestCost = RECVAO(CostFunction, dim, VarSize, VarMin, VarMax, MaxIt, nPop, omega, psi, lambda, mu, mu_damp, delta)
...
%         mu = mu * mu_damp;
        ...
        disp(['In Iteration No ' num2str(it) ': RECVAO Best Cost Is = ' num2str(BestCost(it))]);
    end
