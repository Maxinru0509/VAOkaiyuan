function [BestCost,mu_history4] = trndVAO(CostFunction, dim, VarSize, VarMin, VarMax, MaxIt, nPop, omega, psi, lambda, mu, mu_damp, delta)
...
% Merge 合并
        ...
        disp(['In Iteration No ' num2str(it) ': trndVAO Best Cost Is = ' num2str(BestCost(it))]);
    end
